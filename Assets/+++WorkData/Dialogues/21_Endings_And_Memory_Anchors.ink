...
Michael: We can stop. No more fighting. #avatar:michael
Jack: And then? #avatar:jack
Michael: Remove the name. Open the door. Nobody will ever have to be forgotten again. #avatar:michael
Jack: How? #avatar:jack
~ Event("michael_voice_chorus")
Michael: We’ll remember them. #avatar:michael
~ Event("michael_voice_child")
Michael: Forever. #avatar:michael
...
- else:
    ...
    Michael: That’s it. You opened the door. #avatar:michael
    Michael: Your choice. Your hands. Your decision. #avatar:michael
    Michael: You won’t be forgotten. #avatar:michael
    ~ Event("jack_hands_turn_transparent")
    Jack: Michael… #avatar:jack
    ~ Event("michael_disappears")
    ~ Event("radios_play_jacks_voice")
    Jack’s Voice: Hello? #avatar:jack_radio
    Jack: What’s happening? #avatar:jack
    Jack’s Voice: Can anyone hear me? #avatar:jack_radio
...
- else:
    ...
    Michael: Stop. #avatar:michael
    Jack: Edith remembered this. #avatar:jack
    Michael: She forgot me. #avatar:michael
    Jack: Not completely. #avatar:jack
...
- else:
    ...
    Michael: That’s… My house. #avatar:michael
    Jack: Your family. #avatar:jack
...
- else:
    ...
    Michael: What are you doing? #avatar:michael
    Jack: Remembering you. #avatar:jack
    Michael: I’m right here. #avatar:michael
    Jack: Not all of you. #avatar:jack
...
- else:
    ...
    Jack: You’re Michael Hale. #avatar:jack
    Michael: I don’t want to disappear. #avatar:michael
    Jack: You won’t be forgotten. #avatar:jack
    Michael: You don’t know that. #avatar:michael
    Jack: Your song is remembered. Your face is remembered. Your name is still here. That’s enough. #avatar:jack
    Michael: Please… Don’t turn me off. #avatar:michael
    Jack: I’m sorry. But I can’t let you take anyone else. #avatar:jack
    ~ Event("jack_switches_radio_off")
    ~ Event("radio_click")
    Michael: Thank you. #avatar:michael
